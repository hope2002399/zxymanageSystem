...
public class ServiceConstants {
	...
	public static final String SPECLIAL_KEY = "wxjilove04261802520ysysys";
	...
	public static final String KC_XML = "KCX";// 年报XML
	
	public static final String PRP_XML = "PROPOSAL";// 申报书XML
	
	public static final String PRJ_XML = "PROJECT";// 申报书XML
